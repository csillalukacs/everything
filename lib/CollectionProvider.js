...
export function CollectionProvider({ children }) {
  ...
  async function addItem(name, photoUri, tagNames, isPrivate, description, acquired) {
  ...
  async function updateItem(id, name, photoOrUri, tagNames, isPrivate, description, acquired) {
